    ...
    <>
      <section className="relative overflow-hidden min-h-screen flex flex-col">
        ...
        <div className="absolute inset-0 w-full h-full">
          ...
          >
            <source
              src="https://www.dropbox.com/scl/fi/fvme1d9nszrp6w6q2fvjf/PixVerse_V5_Image_Text_360P_digital_tecnology_.mp4_1757706489551.mp4?rlkey=j1bvrf1sqptriqsukooquyzc3&st=q2jggpwy&dl=1"
              type="video/mp4"
            />
        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 id="main-title" className="text-2xl font-bold tracking-tight text-white sm:text-6xl lg:text-6xl drop-shadow-lg">
                Crafting <strong className="text-white">Next-Gen</strong> Digital Experiences <br />
                from <strong className="text-white">Kolkata</strong> to the <em className="italic text-white">World</em>.
              </h1>
            </motion.div>
            ...
            <motion.p
              ...
              className="mx-auto mb-5 max-w-l text-lg text-gray-200 drop-shadow-md"
            >
            ...
            >
              ...
              <div className="flex items-center justify-center gap-4 flex-wrap">
                <a href="/contact">
                  <div className="group cursor-pointer border border-white/20 bg-white/10 backdrop-blur-sm gap-2 h-[60px] flex items-center p-[10px] rounded-full hover:bg-white/20 transition-all">
                    <div className="border border-white/20 bg-orange-500 h-[40px] rounded-full flex items-center justify-center text-white">
                    ...
                    <div className="text-white group-hover:ml-4 ease-in-out transition-all size-[24px] flex items-center justify-center rounded-full border-2 border-white/20">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="14"
                        height="14"
                ...
                <a href="/work" className="group">
                  <div className="cursor-pointer border border-white/20 bg-transparent backdrop-blur-sm gap-2 h-[60px] flex items-center p-[10px] rounded-full hover:bg-white/10 transition-all">
                    <div className="h-[40px] rounded-full flex items-center justify-center text-white">
                      <p className="font-medium tracking-tight mr-3 ml-3 flex items-center gap-2 justify-center text-base">
                        Explore Our Work
                      </p>
                    </div>
                    <div className="text-white group-hover:ml-2 ease-in-out transition-all size-[24px] flex items-center justify-center rounded-full border-2 border-white/20">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="14"
                        height="14"
