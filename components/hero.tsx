    ...
    <>
      ...
      >
        ...
        <div className="container mx-auto px-4 2xl:max-w-[1400px]">
          ...
          >
            {/* Updated Get Started button to go to Coming Soon */}
            <Link prefetch={false} href="/coming-soon/docs">
            ...
            {/* Updated About button to go to Coming Soon */}
            <Link prefetch={false} href="/coming-soon/about">
